...
const DarkModeBtn: React.FC = function darkModeBtn() {
  ...
  return (
    <button
      className="flex absolute top-32 right-14 w-9 h-9 rounded border border-gray-300 shadow-md justify-center items-center hover:bg-slate-100 dark:border-gray-700 dark:bg-slate-800 transition ease-in-out duration-300"
      onClick={() =>
