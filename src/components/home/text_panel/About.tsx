...
const About: React.FC = function about(): React.ReactElement {
  ...
  return (
    <div className="flex h-full w-full flex-col bg-gradient-to-tl from-blue-400 to-sky-400 justify-between overflow-y-auto px-6 lg:py-2 text-slate-700">
      ...
      <div className="flex flex-wrap w-full flex-row justify-end gap-8 pb-4 lg:pe-8 text-gray-600">
        ...
        <button
          className="flex h-12 flex-row items-center justify-center gap-3 rounded bg-green-400 duration-300 ease-in-out hover:scale-110 hover:bg-green-500 hover:shadow-md lg:hover:shadow-lg dark:hover:from-green-500 dark:hover:to-emerald-500"
