    ...
    <div className="md:mt-20 flex h-fit w-full justify-center">
      <div className="flex h-[38rem] w-[29rem] flex-col rounded-lg border border-slate-300 shadow-lg dark:border-slate-500 dark:shadow-slate-700">
        <div className="flex w-full basis-[15%] items-center justify-center">
          <h1 className="font-[Lexend] text-3xl text-slate-700 dark:text-white">Login</h1>
        </div>
        <div className="flex w-full">
          ...
          >
            <div className="flex w-full flex-col items-center">
              <label className="w-[90%] font-[Lexend] dark:text-slate-200" htmlFor="username">
                Email
              </label>
              <input
            ...
            <div className="flex w-full flex-col items-center">
              <label className="w-[90%] font-[Lexend] dark:text-slate-200" htmlFor="password">
                Password
              </label>
              <input
            ...
            <div className="flex w-[90%] flex-row justify-between">
              <div className="flex flex-row">
                <label htmlFor="check" className="flex gap-2">
                  <input id="check" type="checkbox" className="accent-amber-300" />
